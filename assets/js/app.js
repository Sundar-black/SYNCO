...
// Portfolio Case Studies & Testimonials Data
const portfolioData = {
  "1": {
  ...
  if (bentoCards.length) {
    bentoCards.forEach(card => {
      card.addEventListener('click', () => {
        ...
        if (document.getElementById('svc-modal-badge')) document.getElementById('svc-modal-badge').textContent = data.badge;
        if (document.getElementById('svc-modal-title')) document.getElementById('svc-modal-title').textContent = data.title;
        if (document.getElementById('svc-modal-tagline')) document.getElementById('svc-modal-tagline').textContent = data.tagline;
        if (document.getElementById('svc-modal-overview')) document.getElementById('svc-modal-overview').textContent = data.overview;
  ...
  if (portfolioItems.length && portfolioModal) {
    portfolioItems.forEach(item => {
      item.addEventListener('click', () => {
        ...
        if (document.getElementById('modal-project-cat')) document.getElementById('modal-project-cat').textContent = data.cat;
        if (document.getElementById('modal-project-title')) document.getElementById('modal-project-title').textContent = data.title;
        if (document.getElementById('modal-project-client')) document.getElementById('modal-project-client').textContent = data.client;
        if (document.getElementById('modal-project-spec')) document.getElementById('modal-project-spec').textContent = data.spec;
        if (document.getElementById('modal-project-date')) document.getElementById('modal-project-date').textContent = data.date;
        if (document.getElementById('modal-project-desc')) document.getElementById('modal-project-desc').textContent = data.desc;
        
        if (document.getElementById('modal-project-stat-1')) document.getElementById('modal-project-stat-1').textContent = data.stat1;
        if (document.getElementById('modal-project-stat-lbl-1')) document.getElementById('modal-project-stat-lbl-1').textContent = data.lbl1;
        if (document.getElementById('modal-project-stat-2')) document.getElementById('modal-project-stat-2').textContent = data.stat2;
        if (document.getElementById('modal-project-stat-lbl-2')) document.getElementById('modal-project-stat-lbl-2').textContent = data.lbl2;
        ...
        // Modal GSAP reveal
        gsap.fromTo('#portfolio-modal .modal-content', { scale: 0.85, opacity: 0 }, { scale: 1, opacity: 1, duration: 0.5, ease: 'back.out(1.2)' });
      });
    });

    if (modalClose) {
      modalClose.addEventListener('click', () => {
        gsap.to('#portfolio-modal .modal-content', { scale: 0.85, opacity: 0, duration: 0.3, onComplete: () => {
    ...
    portfolioModal.addEventListener('click', (e) => {
      if (e.target === portfolioModal && modalClose) modalClose.click();
    });
  }
}

function initPortfolioTabs() {
  // Handled inside initPortfolioModals
}
